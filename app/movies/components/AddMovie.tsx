...
const AddMovie: React.FC<AddMovieProps> = ({ onSubmit, onCancel }) => {
  ...
  const handleSubmit = (e: FormEvent) => {
    e.preventDefault();
    onSubmit({ title, year: parseInt(year) || 2024, image: image || '' });
  };

  return (
    <div className='p-4 md:mx-16 md:mt-12'>
      <p className="text-font-primary text-3xl md:text-4xl font-semibold mb-8 md:mb-16">Create a new movie</p>
